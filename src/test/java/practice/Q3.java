...
public class Q3 {
    public static void main(String[] args) {
        System.setProperty("webdriver.chromerdriver.driver", "src/drivers/chromedriver/chromedriver.exe");
        ...
        // fill the firstname
        driver.findElement(By.name("firstname")).sendKeys("Emre" + Keys.ENTER);

        //fill the lastname
        driver.findElement(By.xpath("//input[@name='lastname']")).sendKeys("gençtürk" + Keys.ENTER);
